...
/**
 * Should be used in concert with SuperLoader - these two enable us to look at reloading across classloader boundaries.
 * 
 * @author Andy Clement
 */
public class SubLoader extends ClassLoader {
	...
	static String[] folders = new String[] { 
		TestUtils.getPathToClasses("../org.springsource.loaded.testdata.subloader")
		};
	...
	public SubLoader() {
		super(new SuperLoader());
	}

	public SubLoader(String[] subjars, String[] superjars) {
		super(new SuperLoader(superjars));
	}
	...
	public SubLoader(String metainfFolder, boolean b) {
