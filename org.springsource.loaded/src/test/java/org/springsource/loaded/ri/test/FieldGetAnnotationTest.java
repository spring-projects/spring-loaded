...
public class FieldGetAnnotationTest extends GenerativeSpringLoadedTest {
	...
	protected String getTargetPackage() {
		return "reflection.fieldannotations";
	}
	...
	protected void chooseTestParameters() throws RejectedChoice, Exception {
		...
		testedMethodCaller = "call" + choice("AnnotatedElement", "AccessibleObject", "Field")
	...
	public Result test() throws ResultException, Exception {
		Result r = runOnInstance(callerClazz, callerInstance, testedMethodCaller, field, annotClass);
		return r;
	}
