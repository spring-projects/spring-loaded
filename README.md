...
1.2.4 has now been released: [springloaded-1.2.4.RELEASE.jar](http://repo.spring.io/simple/libs-release-local/org/springframework/springloaded/1.2.4.RELEASE/springloaded-1.2.4.RELEASE.jar)
